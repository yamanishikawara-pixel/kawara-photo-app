                    ...
                    >
                      ...
                      <div style={{ flex: 1, minWidth: 0, alignSelf: 'stretch', display: 'flex', flexDirection: 'column', fontSize: '13px', overflow: 'hidden' }}>
                        ...
                        <div style={{ padding: isPrinting ? '2mm 3mm 2mm 0' : '8px 10px 8px 0', borderBottom: '1px solid #d8d4cc' }}>
                          <div style={{ fontSize: isPrinting ? '7.5pt' : '10px', color: '#1c1f22', fontWeight: 800, letterSpacing: '.1em', fontFamily: JP_FONT }}>＜工程＞</div>
                        ...
                        {/* 確認事項（値があるときのみ） */}
                        {p.checkItem && (
                          <div style={{ padding: isPrinting ? '1.5mm 3mm 1.5mm 0' : '6px 10px 6px 0', borderBottom: '1px solid #d8d4cc' }}>
                            <div style={{ fontSize: isPrinting ? '7.5pt' : '10px', color: '#1c1f22', fontWeight: 800, letterSpacing: '.1em', fontFamily: JP_FONT }}>＜確認事項＞</div>
                        ...
                        {sections.map && p.locationMap && (
                          <div style={{ padding: isPrinting ? '1.5mm 3mm 1.5mm 0' : '6px 10px 6px 0', borderBottom: '1px solid #d8d4cc' }}>
                            <div style={{ fontSize: isPrinting ? '6pt' : '8.5px', color: '#1c1f22', lineHeight: 1.4, fontFamily: JP_FONT }}>
                              {p.locationMap}
                            </div>
                          </div>
                        )}
                        ...
                        {(p.standard || p.actual) && (
                          <div style={{ padding: isPrinting ? '1.5mm 3mm 1.5mm 0' : '6px 10px 6px 0', borderBottom: '1px solid #d8d4cc' }}>
                            <div style={{ display: 'flex', gap: isPrinting ? '3.5mm' : '14px', alignItems: 'flex-end' }}>
                              {p.standard && (
                                <div>
                                  <div style={{ fontSize: isPrinting ? '6pt' : '8px', color: '#1c1f22', fontWeight: 800, letterSpacing: '.1em', fontFamily: JP_FONT }}>基準値</div>
                                  <div style={{ fontSize: isPrinting ? '10pt' : '13px', fontWeight: 900, color: '#1c1f22', lineHeight: 1.05, fontFamily: JP_FONT }}>
                                    {p.standard}
                                  </div>
                                </div>
                              )}
                        ...
                        {/* 説明（値があるときのみ） */}
                        {p.description && (
                          <div style={{ padding: isPrinting ? '2mm 3mm 2mm 0' : '8px 10px 8px 0', overflow: 'hidden' }}>
                            <div style={{ overflow: 'hidden' }}>
                              <div style={{ fontSize: isPrinting ? '7.5pt' : '10px', color: '#1c1f22', fontWeight: 800, letterSpacing: '.05em', marginBottom: isPrinting ? '0.5mm' : '2px', fontFamily: JP_FONT }}>＜説明・備考＞</div>
        ...
        case 'appendix': {
          ...
          <div key={`appendix-${pageIndex}`} style={{ width: isPrinting ? `210mm` : `${A4_WIDTH_PX * scale}px`, height: isPrinting ? `auto` : `${A4_HEIGHT_PX * scale}px` }} className="pdf-page-wrapper relative bg-white shadow-md shrink-0">
            <div className={`pdf-page bg-white overflow-hidden ${isPrinting ? '' : 'absolute top-0 left-0 origin-top-left'}`}
              ...
              <div className="absolute bottom-[10mm] print:bottom-[5mm] right-[15mm] print:right-[8mm] text-xs font-bold text-black">
