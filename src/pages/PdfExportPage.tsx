    ...
    <div className="min-h-screen bg-gray-200 p-4 sm:p-6 font-sans flex flex-col items-center pb-12 overflow-x-hidden w-full relative">
      ...
      <div className="pdf-container-wrapper flex flex-col gap-8 items-center w-full">
        ...
        <div style={wrapperStyle} className="pdf-page-wrapper relative bg-white shadow-md shrink-0">
          <div className="pdf-page absolute top-0 left-0 flex flex-col items-center" style={pageStyle}>
            <div className="mt-[10mm] mb-[30mm] flex flex-col items-center w-full">
              <div className="shrink-0 flex justify-center mb-6">
                {logoUrl ? (
                  <img src={proxyUrl(logoUrl, `logo_${sessionId}`)} alt="自社ロゴ" className="block object-contain" style={{ maxWidth: '40mm', maxHeight: '40mm' }} crossOrigin="anonymous" />
                ) : (
                  <img src={kawaraLogo} alt="標準ロゴ" className="block object-contain grayscale" style={{ maxWidth: '32mm', maxHeight: '32mm' }} crossOrigin="anonymous" />
                )}
              </div>
        ...
        {mapUrlsToRender.map((u, mapIndex) => (
          <div key={`map-page-${mapIndex}`} style={wrapperStyle} className="pdf-page-wrapper relative bg-white shadow-md shrink-0">
            <div className="pdf-page absolute top-0 left-0 flex flex-col" style={pageStyle}>
              <div className="w-full h-full p-6 flex flex-col" style={{ border: '3px solid #1f2937' }}>
                ...
                <div className="p-2 flex-1 flex items-center justify-center overflow-hidden min-h-0 bg-gray-50 border border-gray-400">
                  {u ? (
                            ...
                            <div key={pin.id} className="absolute" style={{ left: `${pin.x}%`, top: `${pin.y}%`, transform: `translate(-50%, -50%) scale(${pin.size ?? 1})`, zIndex: 10 }}>
                              {pin.type === 'arrow' ? (
                                ...
                                <div className="relative flex items-center justify-center">
                                  <div className="w-[14mm] h-[14mm] rounded-full border-4 border-red-600 bg-red-600/10" />
                ...
                <div className="mt-4">
                  ...
                  <div style={{ border: '2px solid #1f2937' }}>
                    <div className="grid grid-cols-12 text-base font-bold bg-gray-100" style={{ borderBottom: '2px solid #1f2937' }}>
                    ...
                    {(() => {
                      ...
                      return displayRows.map((row) => (
                        <div key={row.id} className="grid grid-cols-12 text-base border-b border-gray-400">
                          <div className="col-span-1 py-2 font-bold text-center flex justify-center items-center text-red-700" style={{ borderRight: '1px solid #9ca3af' }}>{row.symbol ?? '　'}</div>
              ...
              <div className="absolute bottom-[10mm] right-[15mm] text-xs text-gray-400">
              ...
              <div className="flex-1 flex flex-col justify-between p-2" style={{ border: '3px solid #1f2937' }}>
                {chunk.map((p, i) => (
                  <div key={i} className="flex gap-2 h-[32%] p-2 rounded border border-gray-500">
                    <div className="w-[60%] flex items-center justify-center overflow-hidden relative min-h-0 bg-gray-50 border-2 border-gray-700">
                      {p.image ? (
                        <div className="flex items-center justify-center w-full h-full">
                    ...
                    <div className="w-[40%] flex flex-col text-sm bg-white border-2 border-gray-700">
